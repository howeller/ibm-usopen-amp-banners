...
p.nominalBounds = new cjs.Rectangle(0,0,3180,180);
...
if (reversed == null) { reversed = false; }
	...
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AGXIAAm3MBdvAAAIAAG3g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:18.75}).wait(1).to({graphics:mask_graphics_1,x:300,y:40.7333}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,10.5,600,71);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("Egu3AC4IAAkNMBdvAAAIAAENg");
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AE/IAAkOMBdvAAAIAAEOg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:18.45}).wait(1).to({graphics:mask_graphics_1,x:300,y:31.875}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,9.9,600,53.9);
...
p.nominalBounds = new cjs.Rectangle(0,0,1590,90);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(866,35,0.3937,0.3935);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_2 = new cjs.Graphics().p("Egu3AC4IAAkNMBdvAAAIAAENg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:300,y:18.45}).wait(218));
	...
	mask_1._off = true;
	var mask_1_graphics_6 = new cjs.Graphics().p("Egu3AE8IAAkOMBdvAAAIAAEOg");
	var mask_1_graphics_57 = new cjs.Graphics().p("Egu3AFaIAAkOMBdvAAAIAAEOg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(6).to({graphics:mask_1_graphics_6,x:300,y:31.65}).wait(51).to({graphics:mask_1_graphics_57,x:300,y:34.65}).wait(163));
	...
	mask_2._off = true;
	var mask_2_graphics_89 = new cjs.Graphics().p("Egu3AC6IAAkNMBdvAAAIAAENg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_2_graphics_89,x:300,y:18.625}).wait(131));
	...
	mask_3._off = true;
	var mask_3_graphics_93 = new cjs.Graphics().p("Egu3AExIAAjxMBdvAAAIAADxg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_3_graphics_93,x:300,y:30.4508}).wait(127));
	...
	mask_4._off = true;
	var mask_4_graphics_187 = new cjs.Graphics().p("Egu3ADAIAAkNMBdvAAAIAAENg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(187).to({graphics:mask_4_graphics_187,x:300,y:19.2}).wait(33));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(187).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(22));

	// textMask (mask)
	var mask_5 = new cjs.Shape();
	mask_5._off = true;
	var mask_5_graphics_195 = new cjs.Graphics().p("Egu3AF/IAAl6MBdvAAAIAAF6g");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(195).to({graphics:mask_5_graphics_195,x:300,y:38.25}).wait(25));

	// cta
	this.ctaBtn = new lib.ctaButton_1();
	this.ctaBtn.name = "ctaBtn";
	this.ctaBtn.setTransform(75.5,98.3,0.804,0.8039,0,0,0,74,19.1);
	this.ctaBtn.alpha = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(195).to({_off:false},0).to({regX:74.2,regY:19.3,scaleY:0.8026,x:75.3,y:59.05,alpha:1},11,cjs.Ease.cubicOut).wait(14));

	// rays
	this.instance_6 = new lib.raysAnim("synched",0,false);
	this.instance_6.setTransform(571.15,21.3,0.5503,0.5482,0,0,0,82,37);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(206).to({_off:false},0).wait(14));

	// sh1_png
	this.instance_7 = new lib.sh1_1("synched",0);
	this.instance_7.setTransform(150,125,1,1,0,0,0,150,125);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(3).to({_off:false},0).to({alpha:1},14).wait(40).to({startPosition:0},0).to({alpha:0},12).wait(151));

	// sh2_png
	this.instance_8 = new lib.sh2_1("synched",0);
	this.instance_8.setTransform(150,125,1,1,0,0,0,150,125);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(89).to({_off:false},0).to({alpha:1},21).wait(50).to({startPosition:0},0).to({alpha:0},12).wait(48));

	// sh3_png
	this.instance_9 = new lib.sh3_1("synched",0);
	this.instance_9.setTransform(150,125,1,1,0,0,0,150,125);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(187).to({_off:false},0).to({alpha:1},19).wait(14));

	// Layer_5
	this.instance_10 = new lib.logoSh_1("synched",0);
	this.instance_10.setTransform(150,300,1,1,0,0,0,150,300);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(57).to({_off:false},0).to({alpha:1},42).wait(121));

	// tennisBall_png
	this.instance_11 = new lib.tennisBallAnim("synched",0,false);
	this.instance_11.setTransform(701.55,50.9,1.0769,1.0764,-90,0,0,85.5,86);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(57).to({startPosition:57},0).to({x:642.55,startPosition:99},42,cjs.Ease.cubicInOut).wait(121));

	// bg
	this.instance_12 = new lib.bg_1("synched",0);
	this.instance_12.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(57).to({startPosition:0},0).to({x:-470},42,cjs.Ease.cubicInOut).wait(121));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-135,-11.4,1725,139);
// library properties:
lib.properties = {
