...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:78.5065,y:22.95}).wait(285));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(21).to({graphics:mask_1_graphics_21,x:158.0065,y:22.95}).wait(266));
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_2_graphics_89,x:150,y:22.5}).wait(11).to({graphics:mask_2_graphics_100,x:150,y:18.5}).wait(187));
	...
	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_3_graphics_93,x:150,y:31.0021}).wait(194));
	...
	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(96).to({graphics:mask_4_graphics_96,x:150,y:42.7457}).wait(191));
	...
	mask_5._off = true;
	var mask_5_graphics_187 = new cjs.Graphics().p("A3bDlIAAlTMAu3AAAIAAFTg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(187).to({graphics:mask_5_graphics_187,x:150,y:22.95}).wait(100));
	...
	mask_6._off = true;
	var mask_6_graphics_191 = new cjs.Graphics().p("A3bGGIAAlUMAu3AAAIAAFUg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:null,x:0,y:0}).wait(191).to({graphics:mask_6_graphics_191,x:150,y:38.95}).wait(96));
	...
	mask_7._off = true;
	var mask_7_graphics_198 = new cjs.Graphics().p("A3bJsIAAncMAu3AAAIAAHcg");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:null,x:0,y:0}).wait(198).to({graphics:mask_7_graphics_198,x:150,y:61.9999}).wait(89));
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(198).to({_off:false},0).to({y:103.9,alpha:1},11,cjs.Ease.cubicInOut).to({_off:true},11).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(206).to({_off:false},0).to({_off:true},14).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(2).to({_off:false},0).to({alpha:1},17).wait(38).to({startPosition:0},0).to({alpha:0},12).to({_off:true},151).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(89).to({_off:false},0).to({alpha:1},18).wait(53).to({startPosition:0},0).to({alpha:0},12).to({_off:true},48).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(187).to({_off:false},0).to({alpha:1},18).to({_off:true},15).wait(67));

	// tennisBall_png
	this.instance_12 = new lib.tennisBallAnim("single",0);
	this.instance_12.setTransform(231.7,222.4,0.8488,0.8486,0,0,0,85.9,86.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(160).to({mode:"synched",startPosition:57,loop:false},0).to({startPosition:99},42,cjs.Ease.cubicInOut).to({_off:true},18).wait(67));

	// bg
	this.instance_13 = new lib.bg_1("synched",0);
	this.instance_13.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(160).to({startPosition:0},0).to({y:496.6},42,cjs.Ease.cubicInOut).to({_off:true},18).wait(67));
