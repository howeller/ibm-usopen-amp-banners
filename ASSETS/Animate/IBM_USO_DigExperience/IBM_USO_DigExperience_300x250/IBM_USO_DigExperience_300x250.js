...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_2 = new cjs.Graphics().p("A3bDlIAAlTMAu3AAAIAAFTg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:150,y:22.95}).wait(218));
	...
	mask_1._off = true;
	var mask_1_graphics_89 = new cjs.Graphics().p("A3bDhIAAlTMAu3AAAIAAFTg");
	var mask_1_graphics_100 = new cjs.Graphics().p("A3bC5IAAlTMAu3AAAIAAFTg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_1_graphics_89,x:150,y:22.5}).wait(11).to({graphics:mask_1_graphics_100,x:150,y:18.5}).wait(120));
	...
	mask_2._off = true;
	var mask_2_graphics_93 = new cjs.Graphics().p("A3bE2IAAkEMAu3AAAIAAEEg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_2_graphics_93,x:150,y:31.0021}).wait(127));
	...
	mask_3._off = true;
	var mask_3_graphics_96 = new cjs.Graphics().p("A3bGrIAAjvMAu3AAAIAADvg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(96).to({graphics:mask_3_graphics_96,x:150,y:42.7457}).wait(124));
	...
	mask_4._off = true;
	var mask_4_graphics_187 = new cjs.Graphics().p("A3bDlIAAlTMAu3AAAIAAFTg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(187).to({graphics:mask_4_graphics_187,x:150,y:22.95}).wait(33));
	...
	mask_5._off = true;
	var mask_5_graphics_191 = new cjs.Graphics().p("A3bGGIAAlUMAu3AAAIAAFUg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(191).to({graphics:mask_5_graphics_191,x:150,y:38.95}).wait(29));
	...
	mask_6._off = true;
	var mask_6_graphics_198 = new cjs.Graphics().p("A3bJsIAAncMAu3AAAIAAHcg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:null,x:0,y:0}).wait(198).to({graphics:mask_6_graphics_198,x:150,y:61.9999}).wait(22));
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(198).to({_off:false},0).to({y:103.9,alpha:1},11,cjs.Ease.cubicInOut).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(2).to({_off:false},0).to({alpha:1},17).wait(38).to({startPosition:0},0).to({alpha:0},12).wait(151));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(89).to({_off:false},0).to({alpha:1},18).wait(53).to({startPosition:0},0).to({alpha:0},12).wait(48));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(187).to({_off:false},0).to({alpha:1},18).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(160).to({startPosition:0},0).to({y:496.6},42,cjs.Ease.cubicInOut).wait(18));
