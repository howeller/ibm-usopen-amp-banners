...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("Egu3AElIAAnVMBdvAAAIAAHVg");
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AHtIAAmMMBdvAAAIAAGMg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:29.35}).wait(1).to({graphics:mask_graphics_1,x:300,y:49.2763}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,11.7,384,86.89999999999999);
...
if (reversed == null) { reversed = false; }
	...
	var mask_graphics_2 = new cjs.Graphics().p("Egu3AImIAAlAMBdvAAAIAAFAg");
	var mask_graphics_3 = new cjs.Graphics().p("Egu3ALEIAAlAMBdvAAAIAAFAg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:22.3}).wait(1).to({graphics:mask_graphics_1,x:300,y:38.7844}).wait(1).to({graphics:mask_graphics_2,x:300,y:55.0029}).wait(1).to({graphics:mask_graphics_3,x:300,y:70.7529}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,0,384,141.5);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Egu3AFBIAAnVMBdvAAAIAAHVg");
	mask.setTransform(300,32.1);
...
p.nominalBounds = new cjs.Rectangle(0,17.2,384,47);
...
// stage content:
(lib.IBM_USO_DigExperience_384x384 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_2 = new cjs.Graphics().p("Egu3AE8IAAnVMBdvAAAIAAHVg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:300,y:31.6}).wait(218));
	...
	mask_1._off = true;
	var mask_1_graphics_89 = new cjs.Graphics().p("Egu3ADtIAAnWMBdvAAAIAAHWg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_1_graphics_89,x:300,y:23.65}).wait(131));
	...
	mask_2._off = true;
	var mask_2_graphics_93 = new cjs.Graphics().p("Egu3AGVIAAloMBdvAAAIAAFog");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_2_graphics_93,x:300,y:40.5035}).wait(127));

	// t1_png
	this.instance_3 = new lib.t2_1("single",1);
	this.instance_3.setTransform(150,338.1,1,1,0,0,0,150,300);
	this.instance_3._off = true;
	...
	mask_3._off = true;
	var mask_3_graphics_96 = new cjs.Graphics().p("Egu3AIoIAAlAMBdvAAAIAAFAg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(96).to({graphics:mask_3_graphics_96,x:300,y:55.2042}).wait(124));

	// t1_png
	this.instance_4 = new lib.t2_1("single",2);
	this.instance_4.setTransform(150,342.1,1,1,0,0,0,150,300);
	this.instance_4._off = true;
	...
	mask_4._off = true;
	var mask_4_graphics_100 = new cjs.Graphics().p("Egu3ALCIAAlAMBdvAAAIAAFAg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(100).to({graphics:mask_4_graphics_100,x:300,y:70.5851}).wait(120));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(100).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(49).to({startPosition:3},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},1).wait(47));

	// textMask (mask)
	var mask_5 = new cjs.Shape();
	mask_5._off = true;
	var mask_5_graphics_187 = new cjs.Graphics().p("Egu3AEjIAAnVMBdvAAAIAAHVg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(187).to({graphics:mask_5_graphics_187,x:300,y:29.1}).wait(33));
	...
	mask_6._off = true;
	var mask_6_graphics_191 = new cjs.Graphics().p("Egu3AHnIAAmAMBdvAAAIAAGAg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:null,x:0,y:0}).wait(191).to({graphics:mask_6_graphics_191,x:300,y:48.6722}).wait(29));
	...
	mask_7._off = true;
	var mask_7_graphics_198 = new cjs.Graphics().p("Egu3AMQIAAqSMBdvAAAIAAKSg");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:null,x:0,y:0}).wait(198).to({graphics:mask_7_graphics_198,x:300,y:78.3599}).wait(22));

	// cta
	this.ctaBtn = new lib.ctaButton_1();
	this.ctaBtn.name = "ctaBtn";
	this.ctaBtn.setTransform(95,178.4,1,1,0,0,0,79,19.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(198).to({_off:false},0).to({y:140.4},11,cjs.Ease.cubicInOut).wait(11));

	// rays
	this.instance_8 = new lib.raysAnim("synched",0,false);
	this.instance_8.setTransform(297.2,213.6,0.9275,0.9217,0,0,0,82.2,37.6);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(206).to({_off:false},0).wait(14));

	// tennisBall_png
	this.instance_9 = new lib.tennisBallAnim("single",0);
	this.instance_9.setTransform(300.5,336.95,1.1119,1.1115,0,0,0,86.5,87.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(160).to({scaleX:1.112,mode:"synched",startPosition:57,loop:false},0).to({scaleX:1.1119,mode:"single",startPosition:99},42,cjs.Ease.cubicInOut).wait(18));

	// bg
	this.instance_10 = new lib.bg_1("synched",0);
	this.instance_10.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(160).to({startPosition:0},0).to({y:430.6},42,cjs.Ease.cubicInOut).wait(18));
