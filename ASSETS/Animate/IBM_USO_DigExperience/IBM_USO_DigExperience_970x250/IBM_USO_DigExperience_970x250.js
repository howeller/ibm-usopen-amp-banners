...
if (reversed == null) { reversed = false; }
	...
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AJtIAAomMBdvAAAIAAImg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:34.55}).wait(1).to({graphics:mask_graphics_1,x:300,y:62.05}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,14.1,600,110);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("Egu3AEvIAAolMBdvAAAIAAIlg");
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AIWIAAnMMBdvAAAIAAHMg");
	var mask_graphics_2 = new cjs.Graphics().p("Egu3AMLIAAnMMBdvAAAIAAHMg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:30.35}).wait(1).to({graphics:mask_graphics_1,x:299.9908,y:53.3731}).wait(1).to({graphics:mask_graphics_2,x:299.9908,y:77.8731}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,5.7,600,150.10000000000002);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Egu3AFcIAAolMBdvAAAIAAIlg");
	mask.setTransform(300,34.8);
...
p.nominalBounds = new cjs.Rectangle(0,14.6,600,54.99999999999999);
...
// stage content:
(lib.IBM_USO_DigExperience_970x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_2 = new cjs.Graphics().p("Egu3AFaIAAolMBdvAAAIAAIlg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:300,y:34.55}).wait(219));
	...
	mask_1._off = true;
	var mask_1_graphics_89 = new cjs.Graphics().p("Egu3AE3IAAolMBdvAAAIAAIlg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_1_graphics_89,x:300,y:31.1}).wait(132));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(89).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(61).to({startPosition:0},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).wait(48));

	// textMask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_93 = new cjs.Graphics().p("Egu3AIuIAAoJMBdvAAAIAAIJg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_2_graphics_93,x:300,y:55.7532}).wait(128));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(93).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(57).to({startPosition:1},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).wait(48));

	// textMask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_97 = new cjs.Graphics().p("Egu3AMKIAAngMBdvAAAIAAHgg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(97).to({graphics:mask_3_graphics_97,x:300,y:77.7915}).wait(124));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(97).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(53).to({startPosition:2},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},1).wait(47));

	// textMask (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	var mask_4_graphics_188 = new cjs.Graphics().p("Egu3AFaIAAolMBdvAAAIAAIlg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(188).to({graphics:mask_4_graphics_188,x:300,y:34.55}).wait(33));
	...
	mask_5._off = true;
	var mask_5_graphics_191 = new cjs.Graphics().p("Egu3AJtIAAomMBdvAAAIAAImg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(191).to({graphics:mask_5_graphics_191,x:300,y:62.05}).wait(30));

	// t1_png
	this.instance_6 = new lib.t3_1("single",1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(191).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(19));

	// textMask (mask)
	var mask_6 = new cjs.Shape();
	mask_6._off = true;
	var mask_6_graphics_196 = new cjs.Graphics().p("Egu3AOSIAAsCMBdvAAAIAAMCg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:null,x:0,y:0}).wait(196).to({graphics:mask_6_graphics_196,x:300,y:91.3899}).wait(25));
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(196).to({_off:false},0).to({x:95,y:162.4},11,cjs.Ease.cubicInOut).wait(14));
	...
	mask_7._off = true;
	mask_7.graphics.p("EApmAMeQiRiQAAjOQAAjNCRiRQCRiQDOAAQDMAACSCQQCRCRAADNQAADOiRCQQiSCSjMAAQjOAAiRiSg");
	mask_7.setTransform(350.8105,94.3665);

	// ballShadow
	this.instance_8 = new lib.ballShadow_1("synched",0);
	this.instance_8.setTransform(605.45,146.75,2.1664,3.5944,-110.9639,0,0,44.1,30.6);
	...
	this.instance_9.setTransform(605.45,146.75,2.1664,3.5944,-110.9628,0,0,44.1,30.6);
	...
	this.instance_10.setTransform(673.35,137,1.0892,1.0888,-90,0,0,43,31.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(221));
	...
	this.instance_12.setTransform(651.7,138.15,1.526,1.9229,-95.9531,0,0,43.8,31.2);
	...
	// tbLines2_png
	this.instance_13 = new lib.lines2("synched",0);
	this.instance_13.setTransform(690.2,145.1,1.1758,1.0907,0,3.3732,0,72.8,40.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(159).to({startPosition:0},0).to({regX:72.4,regY:41.5,scaleX:1.089,scaleY:0.6998,skewX:-9.3081,skewY:-4.2267,x:686.4,y:215.45},16,cjs.Ease.quadIn).to({_off:true},1).wait(10).to({_off:false,regX:73.5,regY:41.9,scaleX:1.0848,scaleY:0.677,skewX:10.9392,skewY:-4.2235,x:686.85,y:66.35},0).to({regX:72.8,regY:40.1,scaleX:1.1758,scaleY:1.0907,skewX:3.3732,skewY:0,x:690.2,y:145.1},15,cjs.Ease.quadOut).wait(20));

	// Layer_27
	this.instance_14 = new lib.lines3("synched",0);
	this.instance_14.setTransform(648.9,226.2,0.9259,0.8552,0,0,0,40.2,37.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(159).to({_off:false},0).wait(11).to({regY:36.7,scaleY:0.898,y:60.6},0).to({regX:40.4,regY:36,scaleX:1.0892,scaleY:1.2186,x:648.95,y:144.2},10,cjs.Ease.quadIn).to({regX:40.2,regY:37.4,scaleX:0.9259,scaleY:0.8552,x:648.9,y:226.2},10,cjs.Ease.quadOut).wait(31));

	// tennisBall_png
	this.instance_15 = new lib.tennisBallLight();
	this.instance_15.setTransform(596.45,189.8,1.0892,1.0888,-90);
	...
	// tennisBall_png
	this.instance_16 = new lib.tennisBall_1("synched",0);
	this.instance_16.setTransform(709.7,106.6,1.0355,1.035,-90,0,0,161.2,166.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(159).to({startPosition:0},0).wait(62));

	// bg
	this.instance_17 = new lib.bg_1("synched",0);
	this.instance_17.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(159).to({startPosition:0},0).to({y:197.6},42,cjs.Ease.cubicInOut).wait(20));
