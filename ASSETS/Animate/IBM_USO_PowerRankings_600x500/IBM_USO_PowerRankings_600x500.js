...
if (reversed == null) { reversed = false; }
	...
	mask_1._off = true;
	var mask_1_graphics_6 = new cjs.Graphics().p("Egu3AJaIAAnhMBdvAAAIAAHhg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(6).to({graphics:mask_1_graphics_6,x:300,y:60.15}).wait(214));
