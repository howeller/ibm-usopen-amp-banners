...
p.nominalBounds = new cjs.Rectangle(0,0,1940,600);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("Egu3AC4IAAkNMBdvAAAIAAENg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:18.45}).wait(1).to({graphics:null,x:0,y:0}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,9.9,600,63.50000000000001);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("Egu3AC8IAAkNMBdvAAAIAAENg");
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AGVIAAm3MBdvAAAIAAG3g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:18.75}).wait(1).to({graphics:mask_graphics_1,x:300,y:40.4833}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,10.5,600,70.5);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Egu3ADHIAAkNMBdvAAAIAAENg");
	mask.setTransform(300,19.95);
...
p.nominalBounds = new cjs.Rectangle(0,12.9,600,27);
...
if (reversed == null) { reversed = false; }
	...
	var mask_graphics_159 = new cjs.Graphics().p("AiwCyQhKhKAAhoQAAhnBKhJQBJhKBnAAQBoAABJBKQBKBJAABnQAABohKBKQhJBJhoAAQhnAAhJhJg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:82.075,y:18.35}).wait(159).to({graphics:mask_graphics_159,x:82.075,y:18.35}).wait(1).to({graphics:null,x:0,y:0}).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(159).to({startPosition:0},0).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(159).to({startPosition:0},0).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(159).to({startPosition:0},0).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(159).to({startPosition:0},0).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(159).to({startPosition:0},0).to({_off:true},1).wait(45));

	// tbLines2_png
	this.instance_5 = new lib.lines2("synched",0);
	this.instance_5.setTransform(78.55,41.5,0.595,0.5527,0,93.3697,90,77.2,41.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(57).to({startPosition:0},0).to({regX:76.5,regY:42.9,scaleX:0.551,scaleY:0.3545,skewX:80.699,skewY:85.7885,x:43.2,y:39.4},16,cjs.Ease.quadIn).to({_off:true},1).wait(10).to({_off:false,regX:78.1,regY:43.2,scaleX:0.5489,scaleY:0.343,skewX:100.9265,skewY:85.7798,x:118.75,y:39.8},0).to({regX:77.2,regY:41.2,scaleX:0.595,scaleY:0.5527,skewX:93.3697,skewY:90,x:78.55,y:41.5},15,cjs.Ease.quadOut).wait(60).to({startPosition:0},0).to({_off:true},1).wait(45));

	// Layer_9
	this.instance_6 = new lib.lines3("synched",0);
	this.instance_6.setTransform(37.65,20.7,0.4685,0.4333,90,0,0,45.6,38.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(57).to({_off:false},0).wait(11).to({regY:37.8,scaleY:0.455,x:121.45},0).to({regX:44.6,regY:37.1,scaleX:0.551,scaleY:0.6175,x:78.95},10,cjs.Ease.quadIn).to({regX:45.6,regY:38.4,scaleX:0.4685,scaleY:0.4333,x:37.65},10,cjs.Ease.quadOut).wait(71).to({startPosition:0},0).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(159).to({_off:true},1).wait(45));

	// tennisBall_png
	this.instance_8 = new lib.tennisBall_1("synched",0);
	this.instance_8.setTransform(101,48.8,0.524,0.5244,0,0,0,165.5,166.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(159).to({startPosition:0},0).to({_off:true},1).wait(45));
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.ray1("synched",4,false);
	...
	// Layer_6
	this.instance_1 = new lib.ray1("synched",4,false);
	...
	// Layer_5
	this.instance_2 = new lib.ray1("synched",4,false);
	...
	// Layer_4
	this.instance_3 = new lib.ray1("synched",4,false);
	...
	// Layer_3
	this.instance_4 = new lib.ray1("synched",4,false);
	this.instance_4.setTransform(133.35,56.7,1,1,60.1354,0,0,-2.4,-48.1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(9).to({_off:false},0).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Am3CWIAAkrINvAAIAAErg");
	mask.setTransform(43.993,14.9999);
...
// stage content:
(lib.IBM_USO_PowerRankings_970x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// border
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("EhLxAHCIAAuDMCXjAAAIAAODgEhLnAG4MCXPAAAIAAtvMiXPAAAg");
	...
	this.clickTag.setTransform(485,45,30.3128,2.8124,0,0,0,16,16);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_2 = new cjs.Graphics().p("Egu3ADFIAAkNMBdvAAAIAAENg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:300,y:19.7}).wait(218));
	...
	mask_1._off = true;
	var mask_1_graphics_89 = new cjs.Graphics().p("Egu3AC6IAAkNMBdvAAAIAAENg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_1_graphics_89,x:300,y:18.625}).wait(131));
	...
	mask_2._off = true;
	var mask_2_graphics_93 = new cjs.Graphics().p("Egu3AExIAAjxMBdvAAAIAADxg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_2_graphics_93,x:300,y:30.4508}).wait(127));
	...
	mask_3._off = true;
	var mask_3_graphics_187 = new cjs.Graphics().p("Egu3ADAIAAkNMBdvAAAIAAENg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(187).to({graphics:mask_3_graphics_187,x:300,y:19.2}).wait(33));

	// t1_png
	this.instance_4 = new lib.t3_1("single",0);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(187).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(22));

	// textMask (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	var mask_4_graphics_195 = new cjs.Graphics().p("Egu3AGGIAAl6MBdvAAAIAAF6g");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(195).to({graphics:mask_4_graphics_195,x:300,y:39}).wait(25));

	// cta
	this.ctaBtn = new lib.ctaButton_1();
	this.ctaBtn.name = "ctaBtn";
	this.ctaBtn.setTransform(94,97.4,1,1,0,0,0,79,19.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(195).to({_off:false},0).to({y:67.4},11,cjs.Ease.cubicInOut).wait(14));

	// rays
	this.instance_5 = new lib.raysAnim("synched",9,false);
	this.instance_5.setTransform(616.15,34.3,0.9273,0.9233,0,0,0,82.8,37.4);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(206).to({_off:false},0).wait(14));

	// tennisBall_png
	this.instance_6 = new lib.tennisBallAnim("synched",0,false);
	this.instance_6.setTransform(683.55,70.9,1.0769,1.0764,-90,0,0,85.5,86);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(160).to({startPosition:57},0).to({x:684.55,startPosition:99},42,cjs.Ease.cubicInOut).wait(18));

	// bg
	this.instance_7 = new lib.bg_1("synched",0);
	this.instance_7.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(160).to({startPosition:0},0).to({y:436.6},42,cjs.Ease.cubicInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(485,-165,485,465);
// library properties:
lib.properties = {
