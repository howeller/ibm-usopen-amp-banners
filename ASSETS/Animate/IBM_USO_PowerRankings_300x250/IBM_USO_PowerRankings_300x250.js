...
p.nominalBounds = new cjs.Rectangle(0,0,263,148);
...
if (reversed == null) { reversed = false; }
	...
	var mask_graphics_1 = new cjs.Graphics().p("A3bFEIAAjwMAu3AAAIAADwg");
	var mask_graphics_2 = new cjs.Graphics().p("A3bG6IAAjwMAu3AAAIAADwg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:150,y:20.2}).wait(1).to({graphics:mask_graphics_1,x:150,y:32.4248}).wait(1).to({graphics:mask_graphics_2,x:150,y:44.1748}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,12.4,300,76);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A3bDGIAAkXMAu3AAAIAAEXg");
	var mask_graphics_1 = new cjs.Graphics().p("A3bFFIAAj5MAu3AAAIAAD5g");
	var mask_graphics_2 = new cjs.Graphics().p("A3bHTIAAkYMAu3AAAIAAEYg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:150,y:19.75}).wait(1).to({graphics:mask_graphics_1,x:150,y:32.5499}).wait(1).to({graphics:mask_graphics_2,x:150,y:46.65}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,11.5,300,81.8);
...
if (reversed == null) { reversed = false; }
	...
	var mask_graphics_1 = new cjs.Graphics().p("A3bFFIAAkYMAu3AAAIAAEYg");
	var mask_graphics_2 = new cjs.Graphics().p("A3bHNIAAkYMAu3AAAIAAEYg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:150,y:19.45}).wait(1).to({graphics:mask_graphics_1,x:150,y:32.5}).wait(1).to({graphics:mask_graphics_2,x:150,y:46.075}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,10.9,300,81.3);
...
p.nominalBounds = new cjs.Rectangle(0,0,300,600.1);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AiwCyQhKhKAAhoQAAhnBKhJQBJhKBnAAQBoAABJBKQBKBJAABnQAABohKBKQhJBJhoAAQhnAAhJhJg");
	mask.setTransform(82.075,18.35);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(57).to({_off:false},0).wait(11).to({regY:37.8,scaleY:0.455,y:-21.5},0).to({regX:44.6,regY:37.1,scaleX:0.551,scaleY:0.6175,y:21},10,cjs.Ease.quadIn).to({regX:45.6,regY:38.4,scaleX:0.4685,scaleY:0.4333,y:62.3},10,cjs.Ease.quadOut).wait(117));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,176,0.5,0.5);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_2 = new cjs.Graphics().p("A3bC9IAAkXMAu3AAAIAAEXg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:150,y:18.95}).wait(218));
	...
	mask_1._off = true;
	var mask_1_graphics_6 = new cjs.Graphics().p("A3bFEIAAkYMAu3AAAIAAEYg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(6).to({graphics:mask_1_graphics_6,x:150,y:32.4}).wait(214));
	...
	mask_2._off = true;
	var mask_2_graphics_9 = new cjs.Graphics().p("A3bHMIAAkYMAu3AAAIAAEYg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(9).to({graphics:mask_2_graphics_9,x:150,y:46.05}).wait(211));
	...
	mask_3._off = true;
	var mask_3_graphics_89 = new cjs.Graphics().p("A3bDIIAAkXMAu3AAAIAAEXg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_3_graphics_89,x:150,y:20}).wait(131));
	...
	mask_4._off = true;
	var mask_4_graphics_93 = new cjs.Graphics().p("A3bFEIAAj6MAu3AAAIAAD6g");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_4_graphics_93,x:150,y:32.4499}).wait(127));
	...
	mask_5._off = true;
	var mask_5_graphics_96 = new cjs.Graphics().p("A3bG8IAAjwMAu3AAAIAADwg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(96).to({graphics:mask_5_graphics_96,x:150,y:44.3998}).wait(124));
	...
	mask_6._off = true;
	var mask_6_graphics_187 = new cjs.Graphics().p("A3bDFIAAkXMAu3AAAIAAEXg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:null,x:0,y:0}).wait(187).to({graphics:mask_6_graphics_187,x:150,y:19.7}).wait(33));
	...
	mask_7._off = true;
	var mask_7_graphics_191 = new cjs.Graphics().p("A3bFeIAAkYMAu3AAAIAAEYg");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:null,x:0,y:0}).wait(191).to({graphics:mask_7_graphics_191,x:150,y:34.95}).wait(29));
	...
	mask_8._off = true;
	var mask_8_graphics_195 = new cjs.Graphics().p("A3bHCIAAkYMAu3AAAIAAEYg");

	this.timeline.addTween(cjs.Tween.get(mask_8).to({graphics:null,x:0,y:0}).wait(195).to({graphics:mask_8_graphics_195,x:150,y:44.95}).wait(25));
	...
	mask_9._off = true;
	var mask_9_graphics_198 = new cjs.Graphics().p("A3bKDIAAmIMAu3AAAIAAGIg");

	this.timeline.addTween(cjs.Tween.get(mask_9).to({graphics:null,x:0,y:0}).wait(198).to({graphics:mask_9_graphics_198,x:150,y:64.2999}).wait(22));

	// cta
	this.ctaBtn = new lib.ctaButton_1();
	this.ctaBtn.name = "ctaBtn";
	this.ctaBtn.setTransform(65.15,140.85,0.6554,0.6564,0,0,0,75.9,20.7);
	this.ctaBtn.alpha = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(198).to({_off:false},0).to({regY:21,y:113.8,alpha:1},11,cjs.Ease.cubicOut).wait(11));

	// rays
	this.instance_10 = new lib.raysAnim("synched",0,false);
	this.instance_10.setTransform(232.55,112.2,0.5623,0.5603,0,0,0,81.8,37.4);
	...
	// tennisBall_png
	this.instance_14 = new lib.tennisBallAnim("synched",0,false);
	this.instance_14.setTransform(235.7,125.4,1,1,0,0,0,85.4,86);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(57).to({startPosition:57},0).to({y:212.4,startPosition:99},42,cjs.Ease.cubicInOut).wait(121));

	// bg
	this.instance_15 = new lib.bg_1("synched",0);
	this.instance_15.setTransform(150,612.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(57).to({startPosition:0},0).to({y:329.6},42,cjs.Ease.cubicInOut).wait(121));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(150,-192,185.5,758.1);
// library properties:
lib.properties = {
