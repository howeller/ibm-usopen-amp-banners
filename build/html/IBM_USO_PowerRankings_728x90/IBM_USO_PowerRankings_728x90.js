...
p.nominalBounds = new cjs.Rectangle(0,0,2500,180);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("Egu3AC2IAAkNMBdvAAAIAAENg");
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AE8IAAkOMBdvAAAIAAEOg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:18.2}).wait(1).to({graphics:mask_graphics_1,x:300,y:31.625}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,9.4,600,53.9);
...
p.nominalBounds = new cjs.Rectangle(0,0,1250,90);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(624,35,0.3937,0.3935);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_2 = new cjs.Graphics().p("Egu3AC7IAAkNMBdvAAAIAAENg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:300,y:18.7}).wait(218));
	...
	mask_1._off = true;
	var mask_1_graphics_6 = new cjs.Graphics().p("Egu3AFBIAAkOMBdvAAAIAAEOg");
	var mask_1_graphics_57 = new cjs.Graphics().p("Egu3AFaIAAkOMBdvAAAIAAEOg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(6).to({graphics:mask_1_graphics_6,x:300,y:32.15}).wait(51).to({graphics:mask_1_graphics_57,x:300,y:34.65}).wait(163));
	...
	mask_2._off = true;
	var mask_2_graphics_89 = new cjs.Graphics().p("Egu3AC+IAAkNMBdvAAAIAAENg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_2_graphics_89,x:300,y:19}).wait(131));
	...
	mask_3._off = true;
	var mask_3_graphics_93 = new cjs.Graphics().p("Egu3AE1IAAjwMBdvAAAIAADwg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_3_graphics_93,x:300,y:30.925}).wait(127));
	...
	this.instance_6.setTransform(450,20.3,0.5504,0.5489,0,0,0,81.8,37);
	this.instance_6._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(57).to({_off:false},0).to({x:-92,alpha:1},42).wait(121));

	// tennisBall_png
	this.instance_11 = new lib.tennisBallAnim("synched",0,false);
	this.instance_11.setTransform(580.55,50.9,1.0769,1.0764,-90,0,0,85.5,86);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(57).to({startPosition:57},0).to({x:520.55,startPosition:99},42,cjs.Ease.cubicInOut).wait(121));

	// bg
	this.instance_12 = new lib.bg_1("synched",0);
	this.instance_12.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(57).to({startPosition:0},0).to({x:-372},42,cjs.Ease.cubicInOut).wait(121));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-158,-11.4,1408,139);
// library properties:
lib.properties = {
