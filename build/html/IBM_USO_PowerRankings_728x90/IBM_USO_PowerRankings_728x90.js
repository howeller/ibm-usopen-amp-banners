...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(57).to({_off:false},0).wait(11).to({regY:37.8,scaleY:0.455,y:-21.5},0).to({regX:44.6,regY:37.1,scaleX:0.551,scaleY:0.6175,y:21},10,cjs.Ease.quadIn).to({regX:45.6,regY:38.4,scaleX:0.4685,scaleY:0.4333,y:62.3},10,cjs.Ease.quadOut).wait(71).to({startPosition:0},0).to({_off:true},1).wait(45));
...
if (reversed == null) { reversed = false; }
	...
	mask_1._off = true;
	var mask_1_graphics_89 = new cjs.Graphics().p("Egu3ADNIAAkNMBdvAAAIAAENg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_1_graphics_89,x:300,y:20.5}).wait(131));
	...
	mask_2._off = true;
	var mask_2_graphics_93 = new cjs.Graphics().p("Egu3AFEIAAjwMBdvAAAIAADwg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_2_graphics_93,x:300,y:32.425}).wait(127));
	...
	this.instance_5.setTransform(463.85,34,0.9214,0.9183,0,0,0,82.5,37);
	...
	this.instance_6.setTransform(463.7,149.15,1.0769,1.0764,0,0,0,85.5,86);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(160).to({startPosition:57},0).to({startPosition:99},42,cjs.Ease.cubicInOut).wait(18));
...
p.nominalBounds = new cjs.Rectangle(364,-165,364,465);
// library properties:
lib.properties = {
