...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A3bDaIAAkrMAu3AAAIAAErg");
	var mask_graphics_1 = new cjs.Graphics().p("A3bFnIAAkMMAu3AAAIAAEMg");
	var mask_graphics_2 = new cjs.Graphics().p("A3bIjIAAkMMAu3AAAIAAEMg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:150,y:21.825}).wait(1).to({graphics:mask_graphics_1,x:150,y:35.9178}).wait(1).to({graphics:mask_graphics_2,x:150,y:54.6678}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,13.7,300,95.7);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A3bDTIAAkrMAu3AAAIAAErg");
	var mask_graphics_1 = new cjs.Graphics().p("A3bGGIAAkXMAu3AAAIAAEXg");
	var mask_graphics_2 = new cjs.Graphics().p("A3bJXIAAlKMAu3AAAIAAFKg");
	var mask_graphics_3 = new cjs.Graphics().p("A3bMLIAAk/MAu3AAAIAAE/g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:150,y:21.125}).wait(1).to({graphics:mask_graphics_1,x:150,y:38.9786}).wait(1).to({graphics:mask_graphics_2,x:150,y:59.9246}).wait(1).to({graphics:mask_graphics_3,x:150,y:77.9495}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,12.3,300,143.6);
...
// stage content:
(lib.IBM_USO_CloudAI_300x300 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(219).call(this.frame_219).wait(77));
	...
	this.timeline.addTween(cjs.Tween.get(this.replayHot).wait(217).to({_off:false},0).to({_off:true},3).wait(76));
	...
	this.timeline.addTween(cjs.Tween.get(this.replay_mc).wait(217).to({_off:false},0).to({_off:true},3).wait(76));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).to({_off:true},220).wait(76));
	...
	this.timeline.addTween(cjs.Tween.get(this.clickTag).to({_off:true},220).wait(76));

	// logo
	this.instance = new lib.logo();
	this.instance.setTransform(0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},220).wait(76));
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:150,y:22.2}).wait(294));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(2).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(44).to({startPosition:0},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},151).wait(76));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(20).to({graphics:mask_1_graphics_20,x:150,y:40.4}).wait(276));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(20).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(26).to({startPosition:1},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},151).wait(76));
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_2_graphics_89,x:150,y:20.25}).wait(207));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(89).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(60).to({startPosition:0},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},48).wait(76));

	// textMask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_93 = new cjs.Graphics().p("A3bGGIAAkXMAu3AAAIAAEXg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_3_graphics_93,x:150,y:38.9786}).wait(203));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(93).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(56).to({startPosition:1},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},48).wait(76));

	// textMask (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	var mask_4_graphics_96 = new cjs.Graphics().p("A3bJUIAAlJMAu3AAAIAAFJg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(96).to({graphics:mask_4_graphics_96,x:150,y:59.6405}).wait(200));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(96).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(53).to({startPosition:2},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},48).wait(76));

	// textMask (mask)
	var mask_5 = new cjs.Shape();
	mask_5._off = true;
	var mask_5_graphics_100 = new cjs.Graphics().p("A3bMNIAAlTMAu3AAAIAAFTg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(100).to({graphics:mask_5_graphics_100,x:150,y:78.1401}).wait(196));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(100).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(49).to({startPosition:3},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},1).wait(123));

	// textMask (mask)
	var mask_6 = new cjs.Shape();
	mask_6._off = true;
	var mask_6_graphics_187 = new cjs.Graphics().p("A3bDfIAAkrMAu3AAAIAAErg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:null,x:0,y:0}).wait(187).to({graphics:mask_6_graphics_187,x:150,y:22.325}).wait(109));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(187).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).to({_off:true},22).wait(76));

	// textMask (mask)
	var mask_7 = new cjs.Shape();
	mask_7._off = true;
	var mask_7_graphics_191 = new cjs.Graphics().p("A3bFrIAAkQMAu3AAAIAAEQg");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:null,x:0,y:0}).wait(191).to({graphics:mask_7_graphics_191,x:150,y:36.266}).wait(105));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(191).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).to({_off:true},18).wait(76));

	// textMask (mask)
	var mask_8 = new cjs.Shape();
	mask_8._off = true;
	var mask_8_graphics_195 = new cjs.Graphics().p("A3bIfIAAkPMAu3AAAIAAEPg");

	this.timeline.addTween(cjs.Tween.get(mask_8).to({graphics:null,x:0,y:0}).wait(195).to({graphics:mask_8_graphics_195,x:150,y:54.341}).wait(101));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(195).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).to({_off:true},14).wait(76));

	// textMask (mask)
	var mask_9 = new cjs.Shape();
	mask_9._off = true;
	var mask_9_graphics_198 = new cjs.Graphics().p("A3bMlIAAmlMAu3AAAIAAGlg");

	this.timeline.addTween(cjs.Tween.get(mask_9).to({graphics:null,x:0,y:0}).wait(198).to({graphics:mask_9_graphics_198,x:150,y:80.4499}).wait(98));
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(198).to({_off:false},0).to({y:144.9},11,cjs.Ease.cubicInOut).to({_off:true},11).wait(76));

	// rays
	this.instance_10 = new lib.raysAnim("synched",0,false);
	this.instance_10.setTransform(234.15,169.95,0.676,0.6747,0,0,0,81.6,37.1);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(209).to({_off:false},0).to({_off:true},11).wait(76));

	// Layer_6 (mask)
	var mask_10 = new cjs.Shape();
	mask_10._off = true;
	mask_10.graphics.p("AiXCZQhAg/AAhaQAAhZBAg/QA/g/BYAAQBaAAA/A/QA/A/AABZQAABag/A/Qg/A/haAAQhYAAg/g/g");
	mask_10.setTransform(232.875,201.05);

	// ballShadow
	this.instance_11 = new lib.ballShadow_1("synched",0);
	this.instance_11.setTransform(232.7,182.35,0.9436,1.5675,-20.9321,0,0,46.4,32.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({_off:true},220).wait(76));

	// ballShadow
	this.instance_12 = new lib.ballShadow_1("synched",0);
	this.instance_12.setTransform(232.7,182.35,0.9436,1.5675,-20.9321,0,0,46.4,32.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({_off:true},220).wait(76));

	// ballShadow
	this.instance_13 = new lib.ballShadow_1("synched",0);
	this.instance_13.setTransform(236.65,211.8,0.4742,0.4747,0,0,0,48.6,34.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({_off:true},220).wait(76));

	// ballShadow
	this.instance_14 = new lib.ballShadow_1("synched",0);
	this.instance_14.setTransform(236.65,211.8,0.4742,0.4747,0,0,0,48.6,34.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({_off:true},220).wait(76));

	// ballShadow
	this.instance_15 = new lib.ballShadow_1("synched",0);
	this.instance_15.setTransform(236.25,202.45,0.6645,0.8386,-5.9281,0,0,47.7,32.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({_off:true},220).wait(76));

	// tbLines2_png
	this.instance_16 = new lib.lines2("synched",0);
	this.instance_16.setTransform(252.95,204.05,0.512,0.4756,0,3.3442,0,79,42.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(160).to({startPosition:0},0).to({regX:77.7,regY:45.3,scaleX:0.4742,scaleY:0.305,skewX:-9.2828,skewY:-4.1837,x:251.1,y:234.3},16,cjs.Ease.quadIn).to({_off:true},1).wait(10).to({_off:false,regX:80.2,regY:46.5,scaleX:0.4723,scaleY:0.2951,skewX:10.902,skewY:-4.1853,x:251.4,y:169.3},0).to({regX:79,regY:42.6,scaleX:0.512,scaleY:0.4756,skewX:3.3442,skewY:0,x:252.95,y:204.05},15,cjs.Ease.quadOut).to({_off:true},18).wait(76));

	// Layer_27
	this.instance_17 = new lib.lines3("synched",0);
	this.instance_17.setTransform(234.9,239.3,0.4031,0.3728,0,0,0,47.6,40.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(160).to({_off:false},0).wait(11).to({regY:40.6,scaleY:0.3914,y:167.2},0).to({regX:46.3,regY:38.4,scaleX:0.4742,scaleY:0.5314,y:203.8},10,cjs.Ease.quadIn).to({regX:47.6,regY:40.5,scaleX:0.4031,scaleY:0.3728,y:239.3},10,cjs.Ease.quadOut).to({_off:true},29).wait(76));

	// tennisBall_png
	this.instance_18 = new lib.tennisBallLight();
	this.instance_18.setTransform(211.15,177.05,0.4742,0.4747);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).to({_off:true},220).wait(76));

	// tennisBall_png
	this.instance_19 = new lib.tennisBall_1("synched",0);
	this.instance_19.setTransform(250.1,227.5,0.451,0.4512,0,0,0,167,168.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_19).to({_off:true},220).wait(76));

	// bg
	this.instance_20 = new lib.bg_1("synched",0);
	this.instance_20.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(160).to({startPosition:0},0).to({y:511.6},42,cjs.Ease.cubicInOut).to({_off:true},18).wait(76));
