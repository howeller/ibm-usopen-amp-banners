...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:300,y:30.2}).wait(230));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(23).to({graphics:mask_1_graphics_23,x:300,y:60.15}).wait(209));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(23).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(23).to({startPosition:1},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_2_graphics_89,x:300,y:31.5526}).wait(143));
	...
	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_3_graphics_93,x:300,y:54.7776}).wait(139));
	...
	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(96).to({graphics:mask_4_graphics_96,x:300,y:77.05}).wait(136));
	...
	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(99).to({graphics:mask_5_graphics_99,x:300,y:101.85}).wait(133));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(99).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(62).to({startPosition:3},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).wait(48));

	// textMask (mask)
	var mask_6 = new cjs.Shape();
	mask_6._off = true;
	var mask_6_graphics_199 = new cjs.Graphics().p("Egu3AE+IAAnwMBdvAAAIAAHwg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:null,x:0,y:0}).wait(199).to({graphics:mask_6_graphics_199,x:300,y:31.7526}).wait(33));
	...
	mask_7._off = true;
	var mask_7_graphics_203 = new cjs.Graphics().p("Egu3AIZIAAmuMBdvAAAIAAGug");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:null,x:0,y:0}).wait(203).to({graphics:mask_7_graphics_203,x:300,y:53.6921}).wait(29));
	...
	mask_8._off = true;
	var mask_8_graphics_210 = new cjs.Graphics().p("Egu3APXIAAqgMBdvAAAIAAKgg");

	this.timeline.addTween(cjs.Tween.get(mask_8).to({graphics:null,x:0,y:0}).wait(210).to({graphics:mask_8_graphics_210,x:300,y:98.2999}).wait(22));
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(210).to({_off:false},0).to({y:150,alpha:1},11,cjs.Ease.cubicOut).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(218).to({_off:false},0).wait(14));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(3).to({_off:false},0).to({alpha:1},17).wait(37).to({startPosition:0},0).to({alpha:0},12).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(89).to({_off:false},0).to({alpha:1},21).wait(62).to({startPosition:0},0).to({alpha:0},12).wait(48));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(199).to({_off:false},0).to({alpha:1},19).wait(14));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(57).to({_off:false},0).to({alpha:1},42).wait(133));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(232));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(232));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(232));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(232));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(232));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(172).to({regX:74.8,scaleX:1.0797,scaleY:1.0018,skewX:3.4065,x:512.55},0).to({regY:38.3,scaleX:1,scaleY:0.643,skewX:-9.3452,skewY:-4.259,x:508.95,y:326.6},16,cjs.Ease.quadIn).to({_off:true},1).wait(10).to({_off:false,regX:75.5,regY:39.2,scaleX:0.9961,scaleY:0.6222,skewX:10.9831,skewY:-4.2581,x:509.6,y:189.9},0).to({regX:74.8,regY:38.2,scaleX:1.0797,scaleY:1.0018,skewX:3.4065,skewY:0,x:512.55,y:262.2},15,cjs.Ease.quadOut).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(172).to({_off:false},0).wait(11).to({regY:34.6,scaleY:0.8249,y:184.75},0).to({regY:34.5,scaleX:1,scaleY:1.1192,y:261.6},10,cjs.Ease.quadIn).to({regY:34.7,scaleX:0.8503,scaleY:0.7856,y:336.35},10,cjs.Ease.quadOut).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(232));

	// tennisBall_png
	this.instance_22 = new lib.tennisBall_1("single",0);
	this.instance_22.setTransform(506.75,312.35,0.9509,0.9506,0,0,0,163.1,164.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(172).to({mode:"synched"},0).wait(60));

	// bg
	this.instance_23 = new lib.bg_1("synched",0);
	this.instance_23.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(172).to({startPosition:0},0).to({y:345.6},42,cjs.Ease.cubicInOut).wait(18));
