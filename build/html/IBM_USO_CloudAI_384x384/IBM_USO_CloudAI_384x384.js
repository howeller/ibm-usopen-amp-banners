...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("Egu3AEXIAAnVMBdvAAAIAAHVg");
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AHWIAAmMMBdvAAAIAAGMg");
	var mask_graphics_2 = new cjs.Graphics().p("Egu3ALEIAAmMMBdvAAAIAAGMg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:27.85}).wait(1).to({graphics:mask_graphics_1,x:300,y:47.0263}).wait(1).to({graphics:mask_graphics_2,x:300,y:70.7763}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,8.7,384,132.9);
...
if (reversed == null) { reversed = false; }
	...
	var mask_graphics_2 = new cjs.Graphics().p("Egu3ALuIAAm4MBdvAAAIAAG4g");
	var mask_graphics_3 = new cjs.Graphics().p("Egu3APWIAAnCMBdvAAAIAAHCg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:27.15}).wait(1).to({graphics:mask_graphics_1,x:300,y:49.7767}).wait(1).to({graphics:mask_graphics_2,x:300,y:75.0026}).wait(1).to({graphics:mask_graphics_3,x:300,y:98.1576}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,7.3,384,189);
...
// stage content:
(lib.IBM_USO_CloudAI_384x384 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:300,y:27.1}).wait(218));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(21).to({graphics:mask_1_graphics_21,x:300,y:49.7922}).wait(199));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(21).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(25).to({startPosition:1},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).wait(151));

	// textMask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_89 = new cjs.Graphics().p("Egu3AEKIAAnVMBdvAAAIAAHVg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_2_graphics_89,x:300,y:26.65}).wait(131));
	...
	mask_3._off = true;
	var mask_3_graphics_93 = new cjs.Graphics().p("Egu3AHgIAAloMBdvAAAIAAFog");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_3_graphics_93,x:300,y:48.0035}).wait(127));
	...
	mask_4._off = true;
	var mask_4_graphics_96 = new cjs.Graphics().p("Egu3ALsIAAnCMBdvAAAIAAHCg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(96).to({graphics:mask_4_graphics_96,x:300,y:74.8458}).wait(124));
	...
	mask_5._off = true;
	var mask_5_graphics_100 = new cjs.Graphics().p("Egu3APUIAAnCMBdvAAAIAAHCg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(100).to({graphics:mask_5_graphics_100,x:300,y:98.0453}).wait(120));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(100).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(49).to({startPosition:3},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},1).wait(47));

	// textMask (mask)
	var mask_6 = new cjs.Shape();
	mask_6._off = true;
	var mask_6_graphics_187 = new cjs.Graphics().p("Egu3AEUIAAnVMBdvAAAIAAHVg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:null,x:0,y:0}).wait(187).to({graphics:mask_6_graphics_187,x:300,y:27.6}).wait(33));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(187).to({_off:false},0).to({y:299},11,cjs.Ease.quartOut).wait(22));

	// textMask (mask)
	var mask_7 = new cjs.Shape();
	mask_7._off = true;
	var mask_7_graphics_191 = new cjs.Graphics().p("Egu3AHOIAAmAMBdvAAAIAAGAg");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:null,x:0,y:0}).wait(191).to({graphics:mask_7_graphics_191,x:300,y:46.1722}).wait(29));
	...
	mask_8._off = true;
	var mask_8_graphics_195 = new cjs.Graphics().p("Egu3AK5IAAmAMBdvAAAIAAGAg");

	this.timeline.addTween(cjs.Tween.get(mask_8).to({graphics:null,x:0,y:0}).wait(195).to({graphics:mask_8_graphics_195,x:300,y:69.6722}).wait(25));
	...
	mask_9._off = true;
	var mask_9_graphics_198 = new cjs.Graphics().p("Egu3APTIAAqSMBdvAAAIAAKSg");

	this.timeline.addTween(cjs.Tween.get(mask_9).to({graphics:null,x:0,y:0}).wait(198).to({graphics:mask_9_graphics_198,x:300,y:97.8599}).wait(22));
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(198).to({_off:false},0).to({y:179.4},11,cjs.Ease.cubicInOut).wait(11));
	...
	this.instance_11.setTransform(300.5,336.95,1.112,1.1115,0,0,0,86.5,87.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(160).to({mode:"synched",startPosition:57,loop:false},0).to({mode:"single",startPosition:99},42,cjs.Ease.cubicInOut).wait(18));

	// bg
	this.instance_12 = new lib.bg_1("synched",0);
	this.instance_12.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(160).to({startPosition:0},0).to({y:430.6},42,cjs.Ease.cubicInOut).wait(18));
