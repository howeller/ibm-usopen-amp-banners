...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_2 = new cjs.Graphics().p("At0EBIAAlxIbpAAIAAFxg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:88.4903,y:25.6665}).wait(285));
	...
	mask_1._off = true;
	var mask_1_graphics_21 = new cjs.Graphics().p("AAPEBIAAlxIbqAAIAAFxg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(21).to({graphics:mask_1_graphics_21,x:178.4903,y:25.6665}).wait(266));
