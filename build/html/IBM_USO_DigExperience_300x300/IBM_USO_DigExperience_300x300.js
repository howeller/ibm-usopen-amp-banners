...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:89.4974,y:27.2}).wait(297));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(21).to({graphics:mask_1_graphics_21,x:179.4974,y:27.2}).wait(278));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(21).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(25).to({startPosition:0},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},60).wait(170));
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_2_graphics_89,x:150,y:19.5}).wait(210));
	...
	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_3_graphics_93,x:150,y:31.05}).wait(206));
	...
	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(96).to({graphics:mask_4_graphics_96,x:150,y:43.1389}).wait(203));
	...
	mask_5._off = true;
	var mask_5_graphics_199 = new cjs.Graphics().p("A3bD4IAAldMAu3AAAIAAFdg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(199).to({graphics:mask_5_graphics_199,x:150,y:24.825}).wait(100));
	...
	mask_6._off = true;
	var mask_6_graphics_203 = new cjs.Graphics().p("A3bGBIAAk9MAu3AAAIAAE9g");
	var mask_6_graphics_214 = new cjs.Graphics().p("A3bGOIAAk9MAu3AAAIAAE9g");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:null,x:0,y:0}).wait(203).to({graphics:mask_6_graphics_203,x:150,y:38.5312}).wait(11).to({graphics:mask_6_graphics_214,x:150,y:39.7812}).wait(85));
	...
	mask_7._off = true;
	var mask_7_graphics_210 = new cjs.Graphics().p("A3bJ9IAAnqMAu3AAAIAAHqg");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:null,x:0,y:0}).wait(210).to({graphics:mask_7_graphics_210,x:150,y:63.6999}).wait(89));
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(210).to({_off:false},0).to({y:113.9},11,cjs.Ease.cubicInOut).to({_off:true},11).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(221).to({_off:false},0).to({_off:true},11).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({_off:true},232).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({_off:true},232).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({_off:true},232).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({_off:true},232).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({_off:true},232).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(172).to({_off:false},0).wait(11).to({regY:40.6,scaleY:0.3914,y:167.2},0).to({regX:46.3,regY:38.4,scaleX:0.4742,scaleY:0.5314,y:203.8},10,cjs.Ease.quadIn).to({regX:47.6,regY:40.5,scaleX:0.4031,scaleY:0.3728,y:239.3},10,cjs.Ease.quadOut).to({_off:true},29).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).to({_off:true},232).wait(67));

	// tennisBall_png
	this.instance_17 = new lib.tennisBall_1("synched",0);
	this.instance_17.setTransform(250.1,227.5,0.451,0.4512,0,0,0,167,168.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({_off:true},232).wait(67));

	// bg
	this.instance_18 = new lib.bg_1("synched",0);
	this.instance_18.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(172).to({startPosition:0},0).to({y:511.6},42,cjs.Ease.cubicInOut).to({_off:true},18).wait(67));
