...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("Egu3AEjIAAmrMBdvAAAIAAGrg");
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AHzIAAmCMBdvAAAIAAGCg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:29.0768}).wait(1).to({graphics:mask_graphics_1,x:300,y:49.9241}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,15.4,300,84.5);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("Egu3ADkIAAmdMBdvAAAIAAGdg");
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AGBIAAlAMBdvAAAIAAFAg");
	var mask_graphics_2 = new cjs.Graphics().p("Egu3AIiIAAlAMBdvAAAIAAFAg");
	var mask_graphics_3 = new cjs.Graphics().p("Egu3AK/IAAk1MBdvAAAIAAE1g");
	var mask_graphics_4 = new cjs.Graphics().p("Egu3ANfIAAk1MBdvAAAIAAE1g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:22.7509}).wait(1).to({graphics:mask_graphics_1,x:300,y:38.507}).wait(1).to({graphics:mask_graphics_2,x:300,y:54.6274}).wait(1).to({graphics:mask_graphics_3,x:300,y:70.3461}).wait(1).to({graphics:mask_graphics_4,x:300,y:86.3461}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,4.1,300,168.6);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("Egu3AFIIAAp1MBdvAAAIAAJ1g");
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AISIAAmQMBdvAAAIAAGQg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:32.7898}).wait(1).to({graphics:mask_graphics_1,x:300,y:53.025}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,2.6,300,103.5);
...
// stage content:
(lib.IBM_USO_DigExperience_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(219).call(this.frame_219).wait(134));
	...
	this.timeline.addTween(cjs.Tween.get(this.replayHot).wait(217).to({_off:false},0).to({_off:true},3).wait(133));
	...
	this.timeline.addTween(cjs.Tween.get(this.replay_mc).wait(217).to({_off:false},0).to({_off:true},3).wait(133));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).to({_off:true},220).wait(133));
	...
	this.timeline.addTween(cjs.Tween.get(this.clickTag).to({_off:true},220).wait(133));

	// logo
	this.instance = new lib.logo();
	this.instance.setTransform(0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},220).wait(133));

	// textMask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_2 = new cjs.Graphics().p("Egu3AFAIAAoHMBdvAAAIAAIHg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:300,y:31.9694}).wait(351));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(2).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(44).to({startPosition:0},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},151).wait(133));

	// textMask (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_6 = new cjs.Graphics().p("Egu3AITIAAmRMBdvAAAIAAGRg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(6).to({graphics:mask_1_graphics_6,x:300,y:53.05}).wait(347));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(40).to({startPosition:1},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},151).wait(133));

	// textMask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_89 = new cjs.Graphics().p("Egu3ADkIAAmdMBdvAAAIAAGdg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_2_graphics_89,x:300,y:22.7509}).wait(264));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(89).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(60).to({startPosition:0},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},48).wait(133));

	// textMask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_93 = new cjs.Graphics().p("Egu3AF/IAAlKMBdvAAAIAAFKg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_3_graphics_93,x:300,y:38.3115}).wait(260));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(93).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(56).to({startPosition:1},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},48).wait(133));

	// textMask (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	var mask_4_graphics_96 = new cjs.Graphics().p("Egu3AInIAAleMBdvAAAIAAFeg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(96).to({graphics:mask_4_graphics_96,x:300,y:55.0623}).wait(257));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(96).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(53).to({startPosition:2},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},48).wait(133));

	// textMask (mask)
	var mask_5 = new cjs.Shape();
	mask_5._off = true;
	var mask_5_graphics_99 = new cjs.Graphics().p("Egu3ALBIAAlAMBdvAAAIAAFAg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(99).to({graphics:mask_5_graphics_99,x:300,y:70.5199}).wait(254));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(99).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(50).to({startPosition:3},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},48).wait(133));

	// textMask (mask)
	var mask_6 = new cjs.Shape();
	mask_6._off = true;
	var mask_6_graphics_102 = new cjs.Graphics().p("Egu3ANkIAAmRMBdvAAAIAAGRg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:null,x:0,y:0}).wait(102).to({graphics:mask_6_graphics_102,x:300,y:86.75}).wait(251));

	// t1_png
	this.instance_7 = new lib.t2_1("single",4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(102).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(47).to({startPosition:4},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},1).wait(180));

	// textMask (mask)
	var mask_7 = new cjs.Shape();
	mask_7._off = true;
	var mask_7_graphics_187 = new cjs.Graphics().p("Egu3AEdIAAmdMBdvAAAIAAGdg");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:null,x:0,y:0}).wait(187).to({graphics:mask_7_graphics_187,x:300,y:28.4509}).wait(166));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(187).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).to({_off:true},22).wait(133));

	// textMask (mask)
	var mask_8 = new cjs.Shape();
	mask_8._off = true;
	var mask_8_graphics_191 = new cjs.Graphics().p("Egu3AHkIAAlmMBdvAAAIAAFmg");

	this.timeline.addTween(cjs.Tween.get(mask_8).to({graphics:null,x:0,y:0}).wait(191).to({graphics:mask_8_graphics_191,x:300,y:48.4473}).wait(162));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(191).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).to({_off:true},18).wait(133));

	// textMask (mask)
	var mask_9 = new cjs.Shape();
	mask_9._off = true;
	var mask_9_graphics_201 = new cjs.Graphics().p("Egu3ANQIAApQMBdvAAAIAAJQg");

	this.timeline.addTween(cjs.Tween.get(mask_9).to({graphics:null,x:0,y:0}).wait(201).to({graphics:mask_9_graphics_201,x:300,y:84.8228}).wait(152));

	// cta
	this.ctaBtn = new lib.ctaButton_1();
	this.ctaBtn.name = "ctaBtn";
	this.ctaBtn.setTransform(95,189.4,1,1,0,0,0,79,19.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(201).to({_off:false},0).to({y:148.4},11,cjs.Ease.cubicInOut).to({_off:true},8).wait(133));

	// rays
	this.instance_10 = new lib.raysAnim("synched",0,false);
	this.instance_10.setTransform(189.9,319.45,1.2864,1.2856,0,0,0,82.2,37.7);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(206).to({_off:false},0).to({_off:true},14).wait(133));

	// Layer_6 (mask)
	var mask_10 = new cjs.Shape();
	mask_10._off = true;
	mask_10.graphics.p("AHLeqQh1h0AAikQAAilB1h0QB0h0ClAAQCkAAB0B0QB1B0AAClQAACkh1B0Qh0B1ikAAQilAAh0h1g");
	mask_10.setTransform(113.6792,207.8918);

	// ballShadow
	this.instance_11 = new lib.ballShadow_1("synched",0);
	this.instance_11.setTransform(184.4,338.85,1.7361,2.8804,-20.9673,0,0,45.5,30.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({_off:true},220).wait(133));

	// ballShadow
	this.instance_12 = new lib.ballShadow_1("synched",0);
	this.instance_12.setTransform(184.4,338.85,1.7361,2.8804,-20.967,0,0,45.5,30.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({_off:true},220).wait(133));

	// ballShadow
	this.instance_13 = new lib.ballShadow_1("synched",0);
	this.instance_13.setTransform(191.9,393.1,0.8729,0.8727,0,0,0,45.8,30.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({_off:true},220).wait(133));

	// ballShadow
	this.instance_14 = new lib.ballShadow_1("synched",0);
	this.instance_14.setTransform(191.9,393.1,0.8729,0.8727,0,0,0,45.8,30.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({_off:true},220).wait(133));

	// ballShadow
	this.instance_15 = new lib.ballShadow_1("synched",0);
	this.instance_15.setTransform(190.75,375.8,1.223,1.5411,-5.9617,0,0,45.6,30.7);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({_off:true},220).wait(133));

	// tbLines2_png
	this.instance_16 = new lib.lines2("synched",0);
	this.instance_16.setTransform(221.2,378.4,0.8729,0.8727,0,0,0,75.2,38.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(159).to({_off:false},0).wait(11).to({regY:35.4,scaleY:0.7199,y:310.8},0).to({regY:35.1,scaleX:0.8729,scaleY:0.9767,x:188.3,y:377.85},10,cjs.Ease.quadIn).to({regY:35.8,scaleX:0.7422,scaleY:0.6855,x:188.25,y:443.3},10,cjs.Ease.quadOut).to({_off:true},30).wait(133));

	// tennisBall_png
	this.instance_18 = new lib.tennisBallLight();
	this.instance_18.setTransform(147.65,332.2,0.8729,0.8727);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(159).to({_off:true},61).wait(133));

	// tennisBall_png
	this.instance_19 = new lib.tennisBall_1("synched",0);
	this.instance_19.setTransform(216.2,422.15,0.8301,0.8296,0,0,0,163.5,164.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(159).to({startPosition:0},0).to({_off:true},61).wait(133));

	// bg
	this.instance_20 = new lib.bg_1("synched",0);
	this.instance_20.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(159).to({startPosition:0},0).to({y:357.6},42,cjs.Ease.cubicInOut).to({_off:true},19).wait(133));
