...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A3bDoIAAlTMAu3AAAIAAFTg");
	var mask_graphics_1 = new cjs.Graphics().p("A3bF0IAAkjMAu3AAAIAAEjg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:150,y:23.2}).wait(1).to({graphics:mask_graphics_1,x:150,y:37.2462}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,12.4,300,62.1);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A3bC5IAAlTMAu3AAAIAAFTg");
	var mask_graphics_1 = new cjs.Graphics().p("A3bE9IAAkFMAu3AAAIAAEFg");
	var mask_graphics_2 = new cjs.Graphics().p("A3bHWIAAk8MAu3AAAIAAE8g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:150,y:18.5}).wait(1).to({graphics:mask_graphics_1,x:150,y:31.6506}).wait(1).to({graphics:mask_graphics_2,x:150,y:47.0087}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,3,300,91);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A3bDhIAAlUMAu3AAAIAAFUg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:150,y:22.45}).wait(1).to({graphics:null,x:0,y:0}).wait(2));
...
p.nominalBounds = new cjs.Rectangle(0,10.9,300,69.1);
...
// stage content:
(lib.IBM_USO_DigExperience_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_2 = new cjs.Graphics().p("AsQDlIAAlTIYhAAIAAFTg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:78.5065,y:22.95}).wait(297));
	...
	mask_1._off = true;
	var mask_1_graphics_21 = new cjs.Graphics().p("AAKDlIAAlTIYiAAIAAFTg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(21).to({graphics:mask_1_graphics_21,x:158.0065,y:22.95}).wait(278));

	// t1_png
	this.instance_2 = new lib.t1_1("single",0);
	this.instance_2.setTransform(150,333.1,1,1,0,0,0,150,300);
	this.instance_2._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(21).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(25).to({startPosition:0},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},61).wait(169));

	// textMask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_89 = new cjs.Graphics().p("A3bDhIAAlTMAu3AAAIAAFTg");
	var mask_2_graphics_100 = new cjs.Graphics().p("A3bC5IAAlTMAu3AAAIAAFTg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_2_graphics_89,x:150,y:22.5}).wait(11).to({graphics:mask_2_graphics_100,x:150,y:18.5}).wait(199));
	...
	mask_3._off = true;
	var mask_3_graphics_93 = new cjs.Graphics().p("A3bE2IAAkEMAu3AAAIAAEEg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_3_graphics_93,x:150,y:31.0021}).wait(206));
	...
	mask_4._off = true;
	var mask_4_graphics_96 = new cjs.Graphics().p("A3bGrIAAjvMAu3AAAIAADvg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(96).to({graphics:mask_4_graphics_96,x:150,y:42.7457}).wait(203));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(96).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(65).to({startPosition:2},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},48).wait(67));

	// textMask (mask)
	var mask_5 = new cjs.Shape();
	mask_5._off = true;
	var mask_5_graphics_199 = new cjs.Graphics().p("A3bDlIAAlTMAu3AAAIAAFTg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(199).to({graphics:mask_5_graphics_199,x:150,y:22.95}).wait(100));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(199).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).to({_off:true},22).wait(67));

	// textMask (mask)
	var mask_6 = new cjs.Shape();
	mask_6._off = true;
	var mask_6_graphics_203 = new cjs.Graphics().p("A3bGGIAAlUMAu3AAAIAAFUg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:null,x:0,y:0}).wait(203).to({graphics:mask_6_graphics_203,x:150,y:38.95}).wait(96));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(203).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).to({_off:true},18).wait(67));

	// textMask (mask)
	var mask_7 = new cjs.Shape();
	mask_7._off = true;
	var mask_7_graphics_210 = new cjs.Graphics().p("A3bJsIAAncMAu3AAAIAAHcg");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:null,x:0,y:0}).wait(210).to({graphics:mask_7_graphics_210,x:150,y:61.9999}).wait(89));

	// cta
	this.ctaBtn = new lib.ctaButton_1();
	this.ctaBtn.name = "ctaBtn";
	this.ctaBtn.setTransform(95,136.4,1,1,0,0,0,79,19.4);
	this.ctaBtn.alpha = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(210).to({_off:false},0).to({y:103.9,alpha:1},11,cjs.Ease.cubicInOut).to({_off:true},11).wait(67));

	// rays
	this.instance_8 = new lib.raysAnim("synched",0,false);
	this.instance_8.setTransform(230.3,131.75,0.7,0.6966,0,0,0,83.3,38.4);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(218).to({_off:false},0).to({_off:true},14).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(2).to({_off:false},0).to({alpha:1},17).wait(38).to({startPosition:0},0).to({alpha:0},12).to({_off:true},163).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(89).to({_off:false},0).to({alpha:1},18).wait(65).to({startPosition:0},0).to({alpha:0},12).to({_off:true},48).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(199).to({_off:false},0).to({alpha:1},18).to({_off:true},15).wait(67));

	// tennisBall_png
	this.instance_12 = new lib.tennisBallAnim("single",0);
	this.instance_12.setTransform(231.7,222.4,0.8488,0.8486,0,0,0,85.9,86.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(172).to({mode:"synched",startPosition:57,loop:false},0).to({startPosition:99},42,cjs.Ease.cubicInOut).to({_off:true},18).wait(67));

	// bg
	this.instance_13 = new lib.bg_1("synched",0);
	this.instance_13.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(172).to({startPosition:0},0).to({y:496.6},42,cjs.Ease.cubicInOut).to({_off:true},18).wait(67));
