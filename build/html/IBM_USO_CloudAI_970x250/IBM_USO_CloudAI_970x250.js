...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("Egu3AFVIAAolMBdvAAAIAAIlg");
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AJxIAAolMBdvAAAIAAIlg");
	var mask_graphics_2 = new cjs.Graphics().p("Egu3AOoIAAomMBdvAAAIAAImg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:34.05}).wait(1).to({graphics:mask_graphics_1,x:300,y:62.55}).wait(1).to({graphics:mask_graphics_2,x:300,y:93.55}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,13.1,600,174);
...
if (reversed == null) { reversed = false; }
	...
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AJ1IAAonMBdvAAAIAAIng");
	var mask_graphics_2 = new cjs.Graphics().p("Egu3AOcIAAomMBdvAAAIAAImg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:31.35}).wait(1).to({graphics:mask_graphics_1,x:299.9908,y:62.8503}).wait(1).to({graphics:mask_graphics_2,x:299.9908,y:92.3758}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,7.7,600,177.10000000000002);
...
// stage content:
(lib.IBM_USO_CloudAI_970x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(220).call(this.frame_220).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get(this.replayHot).wait(218).to({_off:false},0).to({_off:true},3).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.replay_mc).wait(218).to({_off:false},0).to({_off:true},3).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).to({_off:true},221).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.clickTag).to({_off:true},221).wait(29));

	// logo
	this.instance = new lib.logo();
	this.instance.setTransform(0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},221).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:300,y:30.8}).wait(248));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(2).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(44).to({startPosition:0},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},152).wait(29));

	// textMask (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_6 = new cjs.Graphics().p("Egu3AJTIAAomMBdvAAAIAAImg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(6).to({graphics:mask_1_graphics_6,x:300,y:59.5}).wait(244));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(40).to({startPosition:1},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},152).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(89).to({graphics:mask_2_graphics_89,x:300,y:31.1}).wait(161));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(89).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(61).to({startPosition:0},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},48).wait(29));

	// textMask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_93 = new cjs.Graphics().p("Egu3AJ5IAAonMBdvAAAIAAIng");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_3_graphics_93,x:300,y:63.2548}).wait(157));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(93).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(57).to({startPosition:1},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},48).wait(29));

	// textMask (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	var mask_4_graphics_97 = new cjs.Graphics().p("Egu3AObIAAocMBdvAAAIAAIcg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(97).to({graphics:mask_4_graphics_97,x:300,y:92.2682}).wait(153));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(97).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).wait(53).to({startPosition:2},0).to({y:273,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},1).wait(76));

	// textMask (mask)
	var mask_5 = new cjs.Shape();
	mask_5._off = true;
	var mask_5_graphics_188 = new cjs.Graphics().p("Egu3AFVIAAolMBdvAAAIAAIlg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(188).to({graphics:mask_5_graphics_188,x:300,y:34.05}).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(188).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).to({_off:true},22).wait(29));

	// textMask (mask)
	var mask_6 = new cjs.Shape();
	mask_6._off = true;
	var mask_6_graphics_191 = new cjs.Graphics().p("Egu3AJxIAAolMBdvAAAIAAIlg");

	this.timeline.addTween(cjs.Tween.get(mask_6).to({graphics:null,x:0,y:0}).wait(191).to({graphics:mask_6_graphics_191,x:300,y:62.55}).wait(59));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(191).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).to({_off:true},19).wait(29));

	// textMask (mask)
	var mask_7 = new cjs.Shape();
	mask_7._off = true;
	var mask_7_graphics_194 = new cjs.Graphics().p("Egu3APAIAAomMBdvAAAIAAImg");

	this.timeline.addTween(cjs.Tween.get(mask_7).to({graphics:null,x:0,y:0}).wait(194).to({graphics:mask_7_graphics_194,x:300,y:96.05}).wait(56));

	// t1_png
	this.instance_8 = new lib.t3_1("single",2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(194).to({_off:false},0).to({y:300},11,cjs.Ease.quartOut).to({_off:true},16).wait(29));

	// textMask (mask)
	var mask_8 = new cjs.Shape();
	mask_8._off = true;
	var mask_8_graphics_200 = new cjs.Graphics().p("Egu3ASgIAAsCMBdvAAAIAAMCg");

	this.timeline.addTween(cjs.Tween.get(mask_8).to({graphics:null,x:0,y:0}).wait(200).to({graphics:mask_8_graphics_200,x:300,y:118.3899}).wait(50));

	// cta
	this.ctaBtn = new lib.ctaButton_1();
	this.ctaBtn.name = "ctaBtn";
	this.ctaBtn.setTransform(94,259.4,1,1,0,0,0,79,19.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.ctaBtn).wait(200).to({_off:false},0).to({x:95,y:216.4},11,cjs.Ease.cubicInOut).to({_off:true},10).wait(29));

	// rays
	this.instance_9 = new lib.raysAnim("synched",0,false);
	this.instance_9.setTransform(652.95,78.5,1.424,1.4191,0,0,0,81.9,37.1);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(207).to({_off:false},0).to({_off:true},14).wait(29));

	// Layer_6 (mask)
	var mask_9 = new cjs.Shape();
	mask_9._off = true;
	mask_9.graphics.p("EApmAMeQiRiQAAjOQAAjNCRiRQCRiQDOAAQDMAACSCQQCRCRAADNQAADOiRCQQiSCSjMAAQjOAAiRiSg");
	mask_9.setTransform(350.8105,94.3665);

	// ballShadow
	this.instance_10 = new lib.ballShadow_1("synched",0);
	this.instance_10.setTransform(605.45,146.75,2.1664,3.5944,-110.9639,0,0,44.1,30.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({_off:true},221).wait(29));

	// ballShadow
	this.instance_11 = new lib.ballShadow_1("synched",0);
	this.instance_11.setTransform(605.45,146.75,2.1664,3.5944,-110.9628,0,0,44.1,30.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({_off:true},221).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({_off:true},221).wait(29));

	// ballShadow
	this.instance_13 = new lib.ballShadow_1("synched",0);
	this.instance_13.setTransform(673.35,137,1.0892,1.0888,-90,0,0,43,31.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({_off:true},221).wait(29));

	// ballShadow
	this.instance_14 = new lib.ballShadow_1("synched",0);
	this.instance_14.setTransform(651.7,138.15,1.526,1.9229,-95.9531,0,0,43.8,31.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({_off:true},221).wait(29));

	// tbLines2_png
	this.instance_15 = new lib.lines2("synched",0);
	this.instance_15.setTransform(690.2,145.1,1.1758,1.0907,0,3.3732,0,72.8,40.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(159).to({startPosition:0},0).to({regX:72.4,regY:41.5,scaleX:1.089,scaleY:0.6998,skewX:-9.3081,skewY:-4.2267,x:686.4,y:215.45},16,cjs.Ease.quadIn).to({_off:true},1).wait(10).to({_off:false,regX:73.5,regY:41.9,scaleX:1.0848,scaleY:0.677,skewX:10.9392,skewY:-4.2235,x:686.85,y:66.35},0).to({regX:72.8,regY:40.1,scaleX:1.1758,scaleY:1.0907,skewX:3.3732,skewY:0,x:690.2,y:145.1},15,cjs.Ease.quadOut).to({_off:true},20).wait(29));

	// Layer_27
	this.instance_16 = new lib.lines3("synched",0);
	this.instance_16.setTransform(648.9,226.2,0.9259,0.8552,0,0,0,40.2,37.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(159).to({_off:false},0).wait(11).to({regY:36.7,scaleY:0.898,y:60.6},0).to({regX:40.4,regY:36,scaleX:1.0892,scaleY:1.2186,x:648.95,y:144.2},10,cjs.Ease.quadIn).to({regX:40.2,regY:37.4,scaleX:0.9259,scaleY:0.8552,x:648.9,y:226.2},10,cjs.Ease.quadOut).to({_off:true},31).wait(29));

	// tennisBall_png
	this.instance_17 = new lib.tennisBallLight();
	this.instance_17.setTransform(596.45,189.8,1.0892,1.0888,-90);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(159).to({_off:true},62).wait(29));

	// tennisBall_png
	this.instance_18 = new lib.tennisBall_1("synched",0);
	this.instance_18.setTransform(709.7,106.6,1.0355,1.035,-90,0,0,161.2,166.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(159).to({startPosition:0},0).to({_off:true},62).wait(29));

	// bg
	this.instance_19 = new lib.bg_1("synched",0);
	this.instance_19.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(159).to({startPosition:0},0).to({y:197.6},42,cjs.Ease.cubicInOut).to({_off:true},20).wait(29));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(0,-324,970,1024);
// library properties:
lib.properties = {
