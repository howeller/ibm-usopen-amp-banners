...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("Egu3ADMIAAkNMBdvAAAIAAENg");
	mask.setTransform(300,20.45);
...
p.nominalBounds = new cjs.Rectangle(0,13.9,600,27);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Egu3AEjIAAm3MBdvAAAIAAG3g");
	mask.setTransform(300,29.0571);
...
p.nominalBounds = new cjs.Rectangle(0,14.1,600,44);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_2 = new cjs.Graphics().p("Egu3AElIAAolMBdvAAAIAAIlg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:300,y:29.3416}).wait(218));
	...
	var mask_3_graphics_198 = new cjs.Graphics().p("Egu3ADKIAAkNMBdvAAAIAAENg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(187).to({graphics:mask_3_graphics_187,x:300,y:19.2}).wait(11).to({graphics:mask_3_graphics_198,x:300,y:20.2}).wait(22));
