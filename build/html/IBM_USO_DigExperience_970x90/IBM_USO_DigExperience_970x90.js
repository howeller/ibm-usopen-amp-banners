...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_2 = new cjs.Graphics().p("Ax4ElIAAolMAjxAAAIAAIlg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_graphics_2,x:114.4958,y:29.3416}).wait(285));
	...
	mask_1._off = true;
	var mask_1_graphics_21 = new cjs.Graphics().p("AAFElIAAolMAjyAAAIAAIlg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(21).to({graphics:mask_1_graphics_21,x:229.4958,y:29.3416}).wait(266));
	...
	var mask_4_graphics_198 = new cjs.Graphics().p("Egu3ADKIAAkNMBdvAAAIAAENg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(187).to({graphics:mask_4_graphics_187,x:300,y:19.2}).wait(11).to({graphics:mask_4_graphics_198,x:300,y:20.2}).wait(89));
