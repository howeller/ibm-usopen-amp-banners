...
if (reversed == null) { reversed = false; }
	...
	var mask_graphics_1 = new cjs.Graphics().p("Egu3AJSIAAngMBdvAAAIAAHgg");
	var mask_graphics_2 = new cjs.Graphics().p("Eg0uAOfIAAocMBpdAAAIAAIcg");
	var mask_graphics_3 = new cjs.Graphics().p("Eg0uATEIAAocMBpdAAAIAAIcg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:300,y:31.8026}).wait(1).to({graphics:mask_graphics_1,x:300,y:59.425}).wait(1).to({graphics:mask_graphics_2,x:337.5,y:92.65}).wait(1).to({graphics:mask_graphics_3,x:337.5,y:122}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,14,600,230);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-300,-389);
...
// stage content:
(lib.IBM_USO_CloudAI_600x500 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	mask_3._off = true;
	var mask_3_graphics_93 = new cjs.Graphics().p("Egu3AJRIAAnxMBdvAAAIAAHxg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(93).to({graphics:mask_3_graphics_93,x:300,y:59.2776}).wait(127));
	...
	mask_4._off = true;
	var mask_4_graphics_96 = new cjs.Graphics().p("Eg0uAOZIAAocMBpdAAAIAAIcg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(96).to({graphics:mask_4_graphics_96,x:337.5,y:92.05}).wait(124));
	...
	mask_5._off = true;
	var mask_5_graphics_99 = new cjs.Graphics().p("Eg1sATCIAAolMBrZAAAIAAIlg");

	this.timeline.addTween(cjs.Tween.get(mask_5).to({graphics:null,x:0,y:0}).wait(99).to({graphics:mask_5_graphics_99,x:343.7439,y:121.8495}).wait(121));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(159).to({regX:74.8,scaleX:1.0797,scaleY:1.0018,skewX:3.4065,x:512.55},0).to({regY:38.3,scaleX:1,scaleY:0.643,skewX:-9.3452,skewY:-4.259,x:508.95,y:326.6},16,cjs.Ease.quadIn).to({_off:true},1).wait(10).to({_off:false,regX:75.5,regY:39.2,scaleX:0.9961,scaleY:0.6222,skewX:10.9831,skewY:-4.2581,x:509.6,y:189.9},0).to({regX:74.8,regY:38.2,scaleX:1.0797,scaleY:1.0018,skewX:3.4065,skewY:0,x:512.55,y:262.2},15,cjs.Ease.quadOut).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(159).to({_off:false},0).wait(11).to({regY:34.6,scaleY:0.8249,y:184.75},0).to({regY:34.5,scaleX:1,scaleY:1.1192,y:261.6},10,cjs.Ease.quadIn).to({regY:34.7,scaleX:0.8503,scaleY:0.7856,y:336.35},10,cjs.Ease.quadOut).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(159).to({startPosition:0},0).wait(61));

	// bg
	this.instance_23 = new lib.bg_1("synched",0);
	this.instance_23.setTransform(150,646.6,1,1,0,0,0,150,646.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(159).to({startPosition:0},0).to({y:345.6},42,cjs.Ease.cubicInOut).wait(19));
